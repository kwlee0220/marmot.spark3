 ...
 */
public class MultiPolygonUDT extends UserDefinedType<MultiPolygon> {
	private static final long serialVersionUID = -1L;

	public static final MultiPolygonUDT UDT;
	...
	@Override
	public InternalRow serialize(MultiPolygon geom) {
	...
	@Override
	public MultiPolygon deserialize(Object datum) {
		if ( datum instanceof InternalRow ) {
			InternalRow row = (InternalRow)datum;
			byte[] wkb = row.getBinary(0);
			return (MultiPolygon)GeometryDataType.fromWkb(wkb);
		}
